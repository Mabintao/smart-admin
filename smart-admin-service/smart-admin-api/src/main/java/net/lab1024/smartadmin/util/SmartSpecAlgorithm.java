...
@Slf4j
public class SmartSpecAlgorithm<T> {
    /**
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> list = new SmartSpecAlgorithm<String>().specesPlan(Arrays.asList(style), Arrays.asList(color), Arrays.asList(size));
